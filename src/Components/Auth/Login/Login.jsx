            ...
            <div className="mx-auto max-w-screen-md py-12 px-4 sm:px-6 md:max-w-screen-xl md:py-20 lg:py-32 md:px-8">
                <div className="md:pr-8 md:w-1/2 xl:pr-0 xl:w-5/12">
                    ...
                    <h1 className="text-3xl text-gray-800 font-bold md:text-4xl md:leading-tight lg:text-5xl lg:leading-tight dark:text-gray-200">
                        Help <span className="text-blue-600 dark:text-blue-500">hungry</span> people
                    </h1>
                    <p className="mt-3 text-base text-gray-500">
                        Help combat hunger and food waste by donating your extra food. Every contribution makes a difference in the lives of those in need. Be a part of the solution today!.
                    </p>
                    ...
                    <form onSubmit={handelLogin}>
                        <div className="mb-4">
                            ...
                            <input required name='email' type="email" id="hs-hero-email-2" className="py-3 px-4 block w-full border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 sm:p-4 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400" placeholder="Email address" />
                        </div>
                        ...
                        <div className="form-control grid">
                            <button onSubmit={handelLogin} className="bnt py-3 px-4 inline-flex justify-center items-center gap-2 rounded-md border border-transparent font-semibold bg-blue-500 text-white hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all text-sm dark:focus:ring-offset-gray-800 sm:p-4">Sign In</button>
                        </div>
                    </form>
