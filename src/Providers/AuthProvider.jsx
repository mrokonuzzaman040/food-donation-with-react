...
const AuthProvider = ({ children }) => {
    ...
    useEffect(() => {
        const unsubscribe = onAuthStateChanged(auth, currentUser => {
            ...
            if (currentUser) {
                axios.post('https://food-donation-server.vercel.app/jwt', loggedUser, { withCredentials: true })
                    .then(res => {
                        console.log('token response', res.data);
                    })
            }
            else {
                axios.post('https://food-donation-server.vercel.app/logout', loggedUser, {
